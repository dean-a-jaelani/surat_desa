      ...
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          <div class="text-center">
            <form method="post" action="<?php echo base_url('Penduduk/updatePhoto/'.$warga['id_penduduk']); ?>" enctype="multipart/form-data">
      ...
      <div class="card card-primary card-outline">
        <div class="card-header p-2">
          <div class="row">
            ...
            <div class="col-md-3">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-primary"> Update
              </button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Update Data Penduduk</h4>
      </div>
