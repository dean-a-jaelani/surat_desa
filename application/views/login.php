...
<div class="login-box">
  <div class="login-logo">
    ...
    <h4>Sistem Informasi Desa | Pelayanan Surat Online</h4>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <?php echo $this->session->flashdata('pesan'); ?>
      <form action="<?php echo base_url();?>auth/getLogin" method="post">
...
<hr>
      <p class="mb-0">
        <a href="<?php echo base_url('Auth/register'); ?>" class="text-center">Registrasi</a>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
